...
void Selection::selectPortion( LineNumber line, qsizetype start_column, qsizetype end_column )
{
...
bool Selection::isPortionSelected( LineNumber line, qsizetype startColumn, qsizetype endColumn ) const
{
