...
xcopy %KLOGG_WORKSPACE%\%KLOGG_BUILD_ROOT%\msvc_*_relwithdebinfo\tbb12.dll %KLOGG_WORKSPACE%\release\ /y
xcopy %KLOGG_WORKSPACE%\%KLOGG_BUILD_ROOT%\msvc_*_relwithdebinfo\tbb12.pdb %KLOGG_WORKSPACE%\release\ /y
